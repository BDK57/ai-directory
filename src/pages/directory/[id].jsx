...
const DirectoryDetail = () => {
  ...
  return (
    ...
    <SliderSection data={tool?.data?.similar_tools}  title={"Similar Tools"} description={"Handpicked tools that are trending and highly rated by our community."} className={'pb-12'}/>
    <SliderSection data={tool?.data?.aitool?.features} title={"Explore Features of Chat GPT"} description={"Handpicked tools that are trending and highly rated by our community."} className={'pb-60 lg:pb-40'} />
    <Footer />
    </>
  );
};

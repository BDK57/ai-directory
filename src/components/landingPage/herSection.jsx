...
const LeftSection = ({ t, i18n }) => {
  return (
    <div className="space-y-6 z-20 flex flex-col justify-center">
      <h1 className="font-clash-display font-semibold  text-start text-3xl md:text-5xl lg:text-4xl xl:text-6xl  -tracking-[3%] lg:leading-tight leading-snug ">
        {t("home.title")}
        <br />{" "}
      ...
      <div className="relative mt-6 lg:w-[80%] w-full">

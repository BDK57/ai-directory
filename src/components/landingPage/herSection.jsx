...
const HeroSection = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden  text-white bg-[#121221] ">
      ...
      {/* Navbar */}
      <div className="absolute left-0 right-0 w-full bottom-0 h-[98vh] z-20">
  <img src={BgImage} alt="AI Guide" className="w-full h-full" />
        ...
        <div
  className="absolute left-[520px] top-[-8px] w-[932px] h-[427px] bg-[#4A4588] blur-[137px] "
></div>

      <Header/>
      {/* <nav className="flex justify-between items-center py-6">
        <div className="text-2xl font-bold uppercase tracking-widest">YourDirectory.AI</div>
        <div className="flex items-center space-x-6">
          <button className="bg-white text-black px-4 py-2 rounded-lg shadow-lg">Sign Up</button>
          <button className="border border-gray-400 px-4 py-2 rounded-lg">Sign In</button>
          <div className="flex items-center space-x-2">
            <span>En</span>
            <img src="https://flagcdn.com/w40/gb.png" alt="English" className="w-5 h-5" />
          </div>
        </div>
      </nav> */}
      ...
      <div className="grid md:grid-cols-2 items-center h-screen mt-40 h-[83.2vh]  px-22 relative container border-x border-x-primary-white-20  z-20">
        {/* Left Side - Text */}
        ...
        <div className="space-y-6 z-20 flex flex-col justify-center">
          ...
          {t("home.title")}
            <br/> <span className="text-primary-yellow text-[80px] font-clash-display font-semibold  tracking-tight">
            {t("home.latestAiTools")}</span>
          </h1>
          <p className="default-paragraph  mt-10 ">
          {t("home.description")}
          </p>

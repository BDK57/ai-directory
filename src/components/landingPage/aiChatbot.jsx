  ...
  return (
    <section className=" bg-[#121221] text-white  px-6">
      ...
      <div className="relative w-full max-w-5xl flex justify-center">
        ...
        {/* Chat Bubbles */}
        <div className="hidden lg:flex absolute top-10 left-[80px] w-[361px] bg-[#2D2B52B2] text-left p-4 rounded-lg border border-[#565569] shadow-md">
...
scelerisque. 
        ...
        <div className="hidden lg:flex absolute top-40 right-8 w-[361px] bg-[#2D2B52B2] text-left p-4 rounded-lg border border-[#565569] shadow-md">
        <h3 className="text-[24px] font-[600] font-clash-display leading-[40px] tracking-[0%]">
  Lorem ipsum dolor
</h3>
...
scelerisque. 
        ...
        <div className="hidden lg:flex absolute bottom-[50px] left-2 w-[361px] bg-[#2D2B52B2] text-left p-4 rounded-lg border border-[#565569] shadow-md">
        <h3 className="text-[24px] font-[600] font-clash-display leading-[40px] tracking-[0%]">
  Lorem ipsum dolor
</h3>

...
const ExploreCategory = () => {
  ...
  return (
    <div className=" bg-primary-black">
      <div className="container border-x border-x-primary-white-20  py-12 relative z-[1]">
        ...
        <BaseTab
          ...
          classNames={{
            cursor: "bg-black",
            tab: "data-[selected=true]:bg-primary-black data-[selected=true]:text-primary-white data-[selected=true]:shadow-[0_14px_29px_rgba(151,71,255,0.2)] transition-all my-8 mx-1.5 border border-primary-white-30 rounded-[10px]",
            tabList: "gap-0 ",
          }}
